...
namespace ThievingSkill.Core
{
    ...
    {
        public const string Boo = "moonslime.Thieving.Cooldown";
        public const string BadLuck = "moonslime.Thieving.BadLuck";
        ...
        {
            BirbCore.Attributes.Log.Trace("Thieving: Trying to Register skill.");
...
//           CheckSkillLevelUp(id, skillLevel, 10, Proffession10a1, Proffession10a2, Proffession10b1, Proffession10b2);
        ...
        private static void CheckSkillLevelUp(string id, int skillLevel, int targetLevel, params KeyedProfession[] professions)
        {
        ...
        private static void ButtonReleased(object sender, ButtonReleasedEventArgs e)
        {
            ...
            foreach (var NPC in location.characters)
            {
                ...
                BirbCore.Attributes.Log.Trace("Thieving: Button pressed, going to go through the list...");
        ...
        public static void Monster_STEALING(NPC npc, Farmer player)
        {
            ...
            Log.Trace($"Stealing vs monster, Dice roll is {diceRoll}, and spook level is {spookLevel}");
        ...
        public static void Villager_STEALING(NPC npc, Farmer player)
        {
            ...
            string type = "Stolen";
            string spookString = ModEntry.Instance.I18N.Get($"moonslime.Thieving.{type}.{npc.Name}.{spookLevel}");
            if (spookString.Contains("no translation"))
            {
                ...
                spookString = ModEntry.Instance.I18N.Get($"moonslime.Thieving.{type}.default.{spookLevel}");
            }
            ...
            Log.Trace($"Stealing vs villager, final Dice roll is {diceRoll}, and spook level is {spookLevel}");
        ...
        public static void CreateLoot(NPC npc, Farmer player, string spookLevel, string item)
        {
            ...
            Log.Trace($"Stealing loot, Loot Dice roll is {finalroll}, spook level is {spookLevel}, and loot chance is {lootChance}");
