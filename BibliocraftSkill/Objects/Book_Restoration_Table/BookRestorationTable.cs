...
namespace BibliocraftSkill.Objects.Book_Restoration_Table
{
    ...
    [XmlType("Mods_moonslime.BibliocraftSkill.Book_Restoration")]
    public class BookRestorationTable : Object
    {
        ...
        public BookRestorationTable()
        {
        }

        public BookRestorationTable(Vector2 v)
            : base(v, "moonslime.BibliocraftSkill.Book_Restoration")
        {
        }
        ...
        public static Item OutputCask(Object machine, Item inputItem, bool probe, MachineItemOutput outputData, Farmer player, out int? overrideMinutesUntilReady)
        {
            ...
            if (!(machine is BookRestorationTable cask))
            {
                return null;
            }

            if (machine.Quality >= 4)
            {
                return null;
            }
        ...
        public override bool placementAction(GameLocation location, int x, int y, Farmer who = null)
        {
            ...
            location.objects.Add(vector, new BookRestorationTable(vector));
