        ...
        *********/
        ...
        public static bool Before_ClickCraftingRecipe(CraftingPage __instance, ClickableTextureComponent c, bool playSound, ref int ___currentCraftingPage, ref Item ___heldItem, ref bool ___cooking)
        {
            ...
            if (___cooking)
            {
                ...
                Log.Warn(itemObj.Name);
                if (itemObj.Name == "Water" || itemObj.Name == "Bottled Water") { Edibility = 0; }

                SpaceCore.Skills.AddExperience(Game1.player, "spacechase0.Cooking", Edibility);
                // custom code ends
            }
            if (!___cooking)
