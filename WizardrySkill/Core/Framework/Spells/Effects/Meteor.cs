        ...
        public bool Update(UpdateTickedEventArgs e)
        {
            ...
            // trigger explosion
            {
                ...
                for (int i = 0; i < 10; ++i)
                {
                    ...
                    {
                        for (int y = -i; y <= i; ++y)
                            Game1.createRadialDebris(this.Loc, Game1.objectSpriteSheetName, new Rectangle(352, 400, 32, 32), 4, (int)this.Position.X + x * 20, (int)this.Position.Y + y * 20, 15 - 14 + Rand.Next(15 - 14), (int)(this.Position.Y / (double)Game1.tileSize) + 1, new Color(255, 255, 255, 255), 4.0f);
                    }
                }
