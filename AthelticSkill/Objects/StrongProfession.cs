...
{
    public class StrongProfession : Skills.Skill.Profession
    {
        ...
        public StrongProfession(Skills.Skill skill, string id, Texture2D icon, ITranslationHelper i18n, object tokens = null) : base(skill, id)
        {
            this.Icon = icon;
            this.I18n = i18n;
            this.Tokens = tokens;
        ...
        public StrongProfession(Skills.Skill skill, string id, Texture2D icon, Texture2D prestigeIcon, IModHelper modHelper, object tokens = null) : base(skill, id)
        {
            this.Icon = icon;
